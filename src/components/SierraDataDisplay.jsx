...
function SierraDataDisplay() {
  ...
  const [bodyImages, setBodyImages] = useState([]);
    ...
    useEffect(() => {
    fetch('http://localhost:5000/api/sierraTeam')
      .then(res => {
    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.tableWrapper}>
        <div className={styles.description}>
          <h3>Sierra is one of the three Team GO Rocket Leaders. She always leads with the first Pokémon on this page.</h3>
        </div>
        <div className={styles.subtitle}>
          <h2>Sierra's Pokémon</h2>
          <h3>These are the Pokémon Sierra uses in her current lineup with reccommendations to beat them. <br />If you don't have Mega or Shadow versions of these Pokémon, regular versions can still be effective.</h3>
          <h3>Note that Sierra's Pokémon may change in the future, so this data may not always be accurate.</h3>
...
export default SierraDataDisplay;